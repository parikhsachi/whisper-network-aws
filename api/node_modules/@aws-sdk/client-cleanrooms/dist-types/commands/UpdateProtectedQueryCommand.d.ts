...
declare const UpdateProtectedQueryCommand_base: {
    new (input: UpdateProtectedQueryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProtectedQueryCommandInput, UpdateProtectedQueryCommandOutput, CleanRoomsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateProtectedQueryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProtectedQueryCommandInput, UpdateProtectedQueryCommandOutput, CleanRoomsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

...
export var AccessBudgetsPrivacyTemplateParametersInput$ = [3, n0, _ABPTPI,
    0,
    [_bP, _rA],
    [() => BudgetParameters, 0]
];
export var AccessBudgetsPrivacyTemplateParametersOutput$ = [3, n0, _ABPTPO,
    0,
    [_bP, _rA],
    [() => BudgetParameters, 0]
];
export var AccessBudgetsPrivacyTemplateUpdateParameters$ = [3, n0, _ABPTUP,
    0,
    [_bP],
    [() => BudgetParameters]
];
...
export var AggregationConstraint$ = [3, n0, _ACg,
    0,
    [_cNo, _mi, _t],
    [0, 1, 0]
];
...
export var AnalysisRuleList$ = [3, n0, _ARL,
    0,
    [_jC, _aJO, _lC, _aA],
    [64 | 0, 64 | 0, 64 | 0, 0]
];
...
export var AnalysisTemplate$ = [3, n0, _AT,
    ...
    [0, 0, 0, 0, 0, 0, 0, 0, 4, 4, () => AnalysisSchema$, 0, [() => AnalysisSource$, 0], () => AnalysisSourceMetadata$, [() => AnalysisParameterList, 0], () => AnalysisTemplateValidationStatusDetailList, () => ErrorMessageConfiguration$, () => SyntheticDataParameters$]
];
...
export var AnalysisTemplateArtifactMetadata$ = [3, n0, _ATAM,
    0,
    [_ePH, _aAH],
    [() => Hash$, () => HashList]
];
export var AnalysisTemplateArtifacts$ = [3, n0, _ATAn,
    0,
    [_eP, _aAd, _rAo],
    [() => AnalysisTemplateArtifact$, () => AnalysisTemplateArtifactList, 0]
];
export var AnalysisTemplateSummary$ = [3, n0, _ATS,
    0,
    [_a, _cT, _i, _n, _uT, _mA, _mI, _cA, _cI, _de, _iSD],
    [0, 4, 0, 0, 4, 0, 0, 0, 0, 0, 2]
];
export var AnalysisTemplateValidationStatusDetail$ = [3, n0, _ATVSD,
    0,
    [_t, _st, _re],
    [0, 0, () => AnalysisTemplateValidationStatusReasonList]
];
export var AnalysisTemplateValidationStatusReason$ = [3, n0, _ATVSR,
    0,
    [_m],
    [0]
];
export var ApprovalStatusDetails$ = [3, n0, _ASD,
    0,
    [_st],
    [0]
];
...
export var BatchGetCollaborationAnalysisTemplateInput$ = [3, n0, _BGCATI,
    0,
    [_cIo, _aTA],
    [[0, 1], 64 | 0]
];
export var BatchGetCollaborationAnalysisTemplateOutput$ = [3, n0, _BGCATO,
    0,
    [_cAT, _er],
    [[() => CollaborationAnalysisTemplateList, 0], () => BatchGetCollaborationAnalysisTemplateErrorList]
];
export var BatchGetSchemaAnalysisRuleError$ = [3, n0, _BGSARE,
    0,
    [_n, _t, _co, _m],
    [0, 0, 0, 0]
];
export var BatchGetSchemaAnalysisRuleInput$ = [3, n0, _BGSARI,
    0,
    [_cIo, _sARR],
    [[0, 1], () => SchemaAnalysisRuleRequestList]
];
export var BatchGetSchemaAnalysisRuleOutput$ = [3, n0, _BGSARO,
    0,
    [_aRn, _er],
    [() => SchemaAnalysisRuleList, () => BatchGetSchemaAnalysisRuleErrorList]
];
export var BatchGetSchemaError$ = [3, n0, _BGSE,
    0,
    [_n, _co, _m],
    [0, 0, 0]
];
export var BatchGetSchemaInput$ = [3, n0, _BGSI,
    0,
    [_cIo, _na],
    [[0, 1], 64 | 0]
];
...
export var BilledResourceUtilization$ = [3, n0, _BRU,
    0,
    [_u],
    [1]
];
export var BudgetParameter$ = [3, n0, _BP,
    0,
    [_t, _b, _aR],
    [0, 1, 0]
];
...
export var ChangeInput$ = [3, n0, _CI,
    0,
    [_sTp, _sp],
...
export var CollaborationAnalysisTemplate$ = [3, n0, _CAT,
    ...
    [0, 0, 0, 0, 0, 0, 0, 4, 4, () => AnalysisSchema$, 0, [() => AnalysisSource$, 0], () => AnalysisSourceMetadata$, [() => AnalysisParameterList, 0], () => AnalysisTemplateValidationStatusDetailList, () => ErrorMessageConfiguration$, () => SyntheticDataParameters$]
];
...
export var CollaborationChangeRequest$ = [3, n0, _CCR,
    0,
    [_i, _cI, _cT, _uT, _st, _iAA, _ch, _ap],
    [0, 0, 4, 4, 0, 2, () => ChangeList, () => ApprovalStatuses]
];
export var CollaborationChangeRequestSummary$ = [3, n0, _CCRS,
    0,
    [_i, _cI, _cT, _uT, _st, _iAA, _ch, _ap],
    [0, 0, 4, 4, 0, 2, () => ChangeList, () => ApprovalStatuses]
];
export var CollaborationChangeSpecification$ = [3, n0, _CCS,
    0,
    [_aACT],
    [64 | 0]
];
export var CollaborationConfiguredAudienceModelAssociation$ = [3, n0, _CCAMA,
    0,
    [_i, _a, _cI, _cA, _cAMA, _n, _de, _cAI, _cT, _uT],
    [0, 0, 0, 0, 0, 0, 0, 0, 4, 4]
];
export var CollaborationConfiguredAudienceModelAssociationSummary$ = [3, n0, _CCAMAS,
    0,
    [_a, _cT, _i, _n, _uT, _cA, _cI, _cAI, _de],
    [0, 4, 0, 0, 4, 0, 0, 0, 0]
];
export var CollaborationIdNamespaceAssociation$ = [3, n0, _CINA,
    0,
    [_i, _a, _cI, _cA, _n, _de, _cAI, _cT, _uT, _iRC, _iRP, _iMC],
    [0, 0, 0, 0, 0, 0, 0, 4, 4, () => IdNamespaceAssociationInputReferenceConfig$, () => IdNamespaceAssociationInputReferenceProperties$, () => IdMappingConfig$]
];
export var CollaborationIdNamespaceAssociationSummary$ = [3, n0, _CINAS,
    0,
    [_a, _cT, _i, _uT, _cA, _cI, _cAI, _iRC, _n, _de, _iRP],
    [0, 4, 0, 4, 0, 0, 0, () => IdNamespaceAssociationInputReferenceConfig$, 0, 0, () => IdNamespaceAssociationInputReferencePropertiesSummary$]
];
export var CollaborationPrivacyBudgetSummary$ = [3, n0, _CPBS,
    0,
    [_i, _pBTI, _pBTA, _cI, _cA, _cAI, _t, _cT, _uT, _b],
    [0, 0, 0, 0, 0, 0, 0, 4, 4, () => PrivacyBudget$]
];
export var CollaborationPrivacyBudgetTemplate$ = [3, n0, _CPBT,
    0,
    [_i, _a, _cI, _cA, _cAI, _cT, _uT, _pBT, _aR, _pa],
    [0, 0, 0, 0, 0, 4, 4, 0, 0, () => PrivacyBudgetTemplateParametersOutput$]
];
export var CollaborationPrivacyBudgetTemplateSummary$ = [3, n0, _CPBTS,
    0,
    [_i, _a, _cI, _cA, _cAI, _pBT, _cT, _uT],
    [0, 0, 0, 0, 0, 0, 4, 4]
];
export var CollaborationSummary$ = [3, n0, _CS,
    0,
    [_i, _a, _n, _cAI, _cDN, _cT, _uT, _mS, _mI, _mA, _aE],
    [0, 0, 0, 0, 0, 4, 4, 0, 0, 0, 0]
];
export var Column$ = [3, n0, _Col,
    0,
    [_n, _t],
    [0, 0]
];
...
export var ConfiguredAudienceModelAssociationSummary$ = [3, n0, _CAMAS,
    0,
    [_mI, _mA, _cA, _cI, _cT, _uT, _i, _a, _n, _cAMA, _de],
    [0, 0, 0, 0, 4, 4, 0, 0, 0, 0, 0]
];
export var ConfiguredTable$ = [3, n0, _CT,
    0,
    [_i, _a, _n, _de, _tR, _cT, _uT, _aRT, _aM, _aCl, _sAM],
    [0, 0, 0, 0, () => TableReference$, 4, 4, 64 | 0, 0, 64 | 0, 64 | 0]
];
export var ConfiguredTableAnalysisRule$ = [3, n0, _CTAR,
    0,
...
export var ConfiguredTableSummary$ = [3, n0, _CTS,
    0,
...
export var CreateAnalysisTemplateInput$ = [3, n0, _CATI,
    ...
    [0, [0, 1], 0, 0, [() => AnalysisSource$, 0], 128 | 0, [() => AnalysisParameterList, 0], () => AnalysisSchema$, () => ErrorMessageConfiguration$, () => SyntheticDataParameters$]
];
...
export var CreateCollaborationChangeRequestOutput$ = [3, n0, _CCCRO,
    0,
    [_cCR],
...
export var CreateConfiguredAudienceModelAssociationOutput$ = [3, n0, _CCAMAO,
    0,
    [_cAMAo],
    [() => ConfiguredAudienceModelAssociation$]
];
export var CreateConfiguredTableAnalysisRuleInput$ = [3, n0, _CCTARI,
    0,
    [_cTIo, _aRTn, _aRP],
    [[0, 1], 0, () => ConfiguredTableAnalysisRulePolicy$]
];
export var CreateConfiguredTableAnalysisRuleOutput$ = [3, n0, _CCTARO,
    0,
    [_aRna],
    [() => ConfiguredTableAnalysisRule$]
];
export var CreateConfiguredTableAssociationAnalysisRuleInput$ = [3, n0, _CCTAARI,
    0,
    [_mIe, _cTAIo, _aRTn, _aRP],
    [[0, 1], [0, 1], 0, () => ConfiguredTableAssociationAnalysisRulePolicy$]
];
export var CreateConfiguredTableAssociationAnalysisRuleOutput$ = [3, n0, _CCTAARO,
    0,
    [_aRna],
    [() => ConfiguredTableAssociationAnalysisRule$]
];
export var CreateConfiguredTableAssociationInput$ = [3, n0, _CCTAI,
    0,
    [_n, _de, _mIe, _cTIo, _rAo, _ta],
    [0, 0, [0, 1], 0, 0, 128 | 0]
];
export var CreateConfiguredTableAssociationOutput$ = [3, n0, _CCTAO,
    0,
    [_cTAo],
    [() => ConfiguredTableAssociation$]
];
export var CreateConfiguredTableInput$ = [3, n0, _CCTI,
    0,
    [_n, _de, _tR, _aCl, _aM, _sAM, _ta],
    [0, 0, () => TableReference$, 64 | 0, 0, 64 | 0, 128 | 0]
];
export var CreateConfiguredTableOutput$ = [3, n0, _CCTO,
    0,
    [_cTo],
    [() => ConfiguredTable$]
];
export var CreateIdMappingTableInput$ = [3, n0, _CIMTI,
    0,
    [_mIe, _n, _de, _iRC, _ta, _kKA],
    [[0, 1], 0, 0, () => IdMappingTableInputReferenceConfig$, 128 | 0, 0]
];
export var CreateIdMappingTableOutput$ = [3, n0, _CIMTO,
    0,
    [_iMT],
    [() => IdMappingTable$]
];
export var CreateIdNamespaceAssociationInput$ = [3, n0, _CINAI,
    0,
    [_mIe, _iRC, _ta, _n, _de, _iMC],
    [[0, 1], () => IdNamespaceAssociationInputReferenceConfig$, 128 | 0, 0, 0, () => IdMappingConfig$]
];
export var CreateIdNamespaceAssociationOutput$ = [3, n0, _CINAO,
    0,
    [_iNA],
...
export var CreateMembershipOutput$ = [3, n0, _CMO,
    0,
    [_mem],
    [() => Membership$]
];
export var CreatePrivacyBudgetTemplateInput$ = [3, n0, _CPBTI,
    0,
    [_mIe, _aR, _pBT, _pa, _ta],
    [[0, 1], 0, 0, () => PrivacyBudgetTemplateParametersInput$, 128 | 0]
];
export var CreatePrivacyBudgetTemplateOutput$ = [3, n0, _CPBTO,
    0,
    [_pBTr],
    [() => PrivacyBudgetTemplate$]
];
export var DataEncryptionMetadata$ = [3, n0, _DEM,
    0,
    [_aCll, _aD, _aJOCWDN, _pN],
    [2, 2, 2, 2]
];
export var DeleteAnalysisTemplateInput$ = [3, n0, _DATI,
    0,
    [_mIe, _aTI],
    [[0, 1], [0, 1]]
];
export var DeleteAnalysisTemplateOutput$ = [3, n0, _DATO,
    0,
    [],
    []
];
export var DeleteCollaborationInput$ = [3, n0, _DCI,
    0,
    [_cIo],
    [[0, 1]]
];
export var DeleteCollaborationOutput$ = [3, n0, _DCO,
    0,
    [],
    []
];
export var DeleteConfiguredAudienceModelAssociationInput$ = [3, n0, _DCAMAI,
    0,
    [_cAMAI, _mIe],
    [[0, 1], [0, 1]]
];
export var DeleteConfiguredAudienceModelAssociationOutput$ = [3, n0, _DCAMAO,
    0,
    [],
    []
];
export var DeleteConfiguredTableAnalysisRuleInput$ = [3, n0, _DCTARI,
    0,
    [_cTIo, _aRTn],
    [[0, 1], [0, 1]]
];
export var DeleteConfiguredTableAnalysisRuleOutput$ = [3, n0, _DCTARO,
    0,
    [],
    []
];
export var DeleteConfiguredTableAssociationAnalysisRuleInput$ = [3, n0, _DCTAARI,
    0,
    [_mIe, _cTAIo, _aRTn],
    [[0, 1], [0, 1], [0, 1]]
];
export var DeleteConfiguredTableAssociationAnalysisRuleOutput$ = [3, n0, _DCTAARO,
    0,
    [],
    []
];
export var DeleteConfiguredTableAssociationInput$ = [3, n0, _DCTAI,
    0,
    [_cTAIo, _mIe],
    [[0, 1], [0, 1]]
];
export var DeleteConfiguredTableAssociationOutput$ = [3, n0, _DCTAO,
    0,
    [],
    []
];
export var DeleteConfiguredTableInput$ = [3, n0, _DCTI,
    0,
    [_cTIo],
    [[0, 1]]
];
export var DeleteConfiguredTableOutput$ = [3, n0, _DCTO,
    0,
    [],
    []
];
export var DeleteIdMappingTableInput$ = [3, n0, _DIMTI,
    0,
    [_iMTI, _mIe],
    [[0, 1], [0, 1]]
];
export var DeleteIdMappingTableOutput$ = [3, n0, _DIMTO,
    0,
    [],
    []
];
export var DeleteIdNamespaceAssociationInput$ = [3, n0, _DINAI,
    0,
    [_iNAI, _mIe],
    [[0, 1], [0, 1]]
];
export var DeleteIdNamespaceAssociationOutput$ = [3, n0, _DINAO,
    0,
    [],
    []
];
...
export var DeleteMembershipInput$ = [3, n0, _DMIe,
    0,
    [_mIe],
    [[0, 1]]
];
export var DeleteMembershipOutput$ = [3, n0, _DMOe,
    0,
    [],
    []
];
export var DeletePrivacyBudgetTemplateInput$ = [3, n0, _DPBTI,
    0,
    [_mIe, _pBTIr],
    [[0, 1], [0, 1]]
];
export var DeletePrivacyBudgetTemplateOutput$ = [3, n0, _DPBTO,
    0,
    [],
    []
];
export var DifferentialPrivacyColumn$ = [3, n0, _DPC,
    0,
    [_n],
    [0]
];
export var DifferentialPrivacyConfiguration$ = [3, n0, _DPCi,
    0,
    [_colu],
    [() => DifferentialPrivacyColumnList]
];
export var DifferentialPrivacyParameters$ = [3, n0, _DPP,
    0,
    [_sP],
    [() => DifferentialPrivacySensitivityParametersList]
];
export var DifferentialPrivacyPreviewAggregation$ = [3, n0, _DPPA,
    0,
    [_t, _mC],
    [0, 1]
];
export var DifferentialPrivacyPreviewParametersInput$ = [3, n0, _DPPPI,
    0,
    [_ep, _uNPQ],
    [1, 1]
];
export var DifferentialPrivacyPrivacyBudget$ = [3, n0, _DPPB,
    0,
    [_ag, _ep],
...
export var DifferentialPrivacyTemplateParametersOutput$ = [3, n0, _DPTPO,
    0,
    [_ep, _uNPQ],
    [1, 1]
];
export var DifferentialPrivacyTemplateUpdateParameters$ = [3, n0, _DPTUP,
    0,
    [_ep, _uNPQ],
    [1, 1]
];
export var DirectAnalysisConfigurationDetails$ = [3, n0, _DACD,
    0,
    [_rAI],
    [64 | 0]
];
...
export var GetCollaborationAnalysisTemplateOutput$ = [3, n0, _GCATO,
    0,
    [_cATo],
    [[() => CollaborationAnalysisTemplate$, 0]]
];
export var GetCollaborationChangeRequestInput$ = [3, n0, _GCCRI,
    0,
    [_cIo, _cRI],
    [[0, 1], [0, 1]]
];
export var GetCollaborationChangeRequestOutput$ = [3, n0, _GCCRO,
    0,
    [_cCR],
    [() => CollaborationChangeRequest$]
];
export var GetCollaborationConfiguredAudienceModelAssociationInput$ = [3, n0, _GCCAMAI,
    0,
    [_cIo, _cAMAI],
    [[0, 1], [0, 1]]
];
export var GetCollaborationConfiguredAudienceModelAssociationOutput$ = [3, n0, _GCCAMAO,
    0,
    [_cCAMA],
    [() => CollaborationConfiguredAudienceModelAssociation$]
];
export var GetCollaborationIdNamespaceAssociationInput$ = [3, n0, _GCINAI,
    0,
    [_cIo, _iNAI],
    [[0, 1], [0, 1]]
];
export var GetCollaborationIdNamespaceAssociationOutput$ = [3, n0, _GCINAO,
    0,
    [_cINA],
    [() => CollaborationIdNamespaceAssociation$]
];
export var GetCollaborationInput$ = [3, n0, _GCI,
    0,
    [_cIo],
    [[0, 1]]
];
...
export var GetCollaborationPrivacyBudgetTemplateOutput$ = [3, n0, _GCPBTO,
    0,
    [_cPBT],
    [() => CollaborationPrivacyBudgetTemplate$]
];
export var GetConfiguredAudienceModelAssociationInput$ = [3, n0, _GCAMAI,
    0,
    [_cAMAI, _mIe],
    [[0, 1], [0, 1]]
];
export var GetConfiguredAudienceModelAssociationOutput$ = [3, n0, _GCAMAO,
    0,
    [_cAMAo],
    [() => ConfiguredAudienceModelAssociation$]
];
export var GetConfiguredTableAnalysisRuleInput$ = [3, n0, _GCTARI,
    0,
    [_cTIo, _aRTn],
    [[0, 1], [0, 1]]
];
export var GetConfiguredTableAnalysisRuleOutput$ = [3, n0, _GCTARO,
    0,
    [_aRna],
    [() => ConfiguredTableAnalysisRule$]
];
export var GetConfiguredTableAssociationAnalysisRuleInput$ = [3, n0, _GCTAARI,
    0,
    [_mIe, _cTAIo, _aRTn],
    [[0, 1], [0, 1], [0, 1]]
];
export var GetConfiguredTableAssociationAnalysisRuleOutput$ = [3, n0, _GCTAARO,
    0,
    [_aRna],
    [() => ConfiguredTableAssociationAnalysisRule$]
];
export var GetConfiguredTableAssociationInput$ = [3, n0, _GCTAI,
    0,
    [_cTAIo, _mIe],
    [[0, 1], [0, 1]]
];
export var GetConfiguredTableAssociationOutput$ = [3, n0, _GCTAO,
    0,
    [_cTAo],
    [() => ConfiguredTableAssociation$]
];
export var GetConfiguredTableInput$ = [3, n0, _GCTI,
    0,
    [_cTIo],
    [[0, 1]]
];
export var GetConfiguredTableOutput$ = [3, n0, _GCTO,
    0,
    [_cTo],
    [() => ConfiguredTable$]
];
export var GetIdMappingTableInput$ = [3, n0, _GIMTI,
    0,
    [_iMTI, _mIe],
    [[0, 1], [0, 1]]
];
export var GetIdMappingTableOutput$ = [3, n0, _GIMTO,
    0,
    [_iMT],
    [() => IdMappingTable$]
];
export var GetIdNamespaceAssociationInput$ = [3, n0, _GINAI,
    0,
    [_iNAI, _mIe],
    [[0, 1], [0, 1]]
];
export var GetIdNamespaceAssociationOutput$ = [3, n0, _GINAO,
    0,
    [_iNA],
    [() => IdNamespaceAssociation$]
];
...
export var GetMembershipOutput$ = [3, n0, _GMO,
    0,
    [_mem],
    [() => Membership$]
];
export var GetPrivacyBudgetTemplateInput$ = [3, n0, _GPBTI,
    0,
    [_mIe, _pBTIr],
    [[0, 1], [0, 1]]
];
export var GetPrivacyBudgetTemplateOutput$ = [3, n0, _GPBTO,
    0,
    [_pBTr],
    [() => PrivacyBudgetTemplate$]
];
export var GetProtectedJobInput$ = [3, n0, _GPJI,
    0,
    [_mIe, _pJI],
    [[0, 1], [0, 1]]
];
...
export var GetProtectedQueryOutput$ = [3, n0, _GPQO,
    0,
    [_pQ],
    [[() => ProtectedQuery$, 0]]
];
export var GetSchemaAnalysisRuleInput$ = [3, n0, _GSARI,
    0,
    [_cIo, _n, _t],
    [[0, 1], [0, 1], [0, 1]]
];
export var GetSchemaAnalysisRuleOutput$ = [3, n0, _GSARO,
    0,
    [_aRna],
    [() => AnalysisRule$]
];
...
export var Hash$ = [3, n0, _H,
    0,
    [_sh],
    [0]
];
export var IdMappingConfig$ = [3, n0, _IMC,
    0,
    [_aUADC],
    [2]
];
export var IdMappingTable$ = [3, n0, _IMT,
    ...
    [0, 0, () => IdMappingTableInputReferenceConfig$, 0, 0, 0, 0, 0, 0, 4, 4, () => IdMappingTableInputReferenceProperties$, 0]
];
...
export var IdMappingTableInputReferenceProperties$ = [3, n0, _IMTIRP,
    0,
    [_iMTIS],
    [() => IdMappingTableInputSourceList]
];
export var IdMappingTableInputSource$ = [3, n0, _IMTIS,
    0,
    [_iNAId, _t],
    [0, 0]
];
...
export var IdNamespaceAssociation$ = [3, n0, _INA,
    0,
    [_i, _a, _mI, _mA, _cI, _cA, _n, _de, _cT, _uT, _iRC, _iRP, _iMC],
    [0, 0, 0, 0, 0, 0, 0, 0, 4, 4, () => IdNamespaceAssociationInputReferenceConfig$, () => IdNamespaceAssociationInputReferenceProperties$, () => IdMappingConfig$]
];
export var IdNamespaceAssociationInputReferenceConfig$ = [3, n0, _INAIRC,
    0,
    [_iRA, _mRP],
    [0, 2]
];
export var IdNamespaceAssociationInputReferenceProperties$ = [3, n0, _INAIRP,
    0,
    [_iNT, _iMWS],
    [0, 64 | 15]
];
export var IdNamespaceAssociationInputReferencePropertiesSummary$ = [3, n0, _INAIRPS,
    0,
    [_iNT],
    [0]
];
export var IdNamespaceAssociationSummary$ = [3, n0, _INAS,
    0,
    [_mI, _mA, _cA, _cI, _cT, _uT, _i, _a, _iRC, _n, _de, _iRP],
    [0, 0, 0, 0, 4, 4, 0, 0, () => IdNamespaceAssociationInputReferenceConfig$, 0, 0, () => IdNamespaceAssociationInputReferencePropertiesSummary$]
];
...
export var ListAnalysisTemplatesOutput$ = [3, n0, _LATO,
    0,
    [_nT, _aTS],
    [0, () => AnalysisTemplateSummaryList]
];
export var ListCollaborationAnalysisTemplatesInput$ = [3, n0, _LCATI,
    0,
    [_cIo, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCollaborationAnalysisTemplatesOutput$ = [3, n0, _LCATO,
    0,
    [_nT, _cATS],
    [0, () => CollaborationAnalysisTemplateSummaryList]
];
export var ListCollaborationChangeRequestsInput$ = [3, n0, _LCCRI,
    0,
    [_cIo, _st, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _st }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCollaborationChangeRequestsOutput$ = [3, n0, _LCCRO,
    0,
    [_cCRS, _nT],
    [() => CollaborationChangeRequestSummaryList, 0]
];
export var ListCollaborationConfiguredAudienceModelAssociationsInput$ = [3, n0, _LCCAMAI,
    0,
    [_cIo, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCollaborationConfiguredAudienceModelAssociationsOutput$ = [3, n0, _LCCAMAO,
    0,
    [_cCAMAS, _nT],
    [() => CollaborationConfiguredAudienceModelAssociationSummaryList, 0]
];
export var ListCollaborationIdNamespaceAssociationsInput$ = [3, n0, _LCINAI,
    0,
    [_cIo, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCollaborationIdNamespaceAssociationsOutput$ = [3, n0, _LCINAO,
    0,
    [_nT, _cINAS],
    [0, () => CollaborationIdNamespaceAssociationSummaryList]
];
export var ListCollaborationPrivacyBudgetsInput$ = [3, n0, _LCPBI,
    0,
    [_cIo, _pBT, _mR, _nT, _aBRA],
    [[0, 1], [0, { [_hQ]: _pBT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _nT }], [0, { [_hQ]: _aBRA }]]
];
export var ListCollaborationPrivacyBudgetsOutput$ = [3, n0, _LCPBO,
    0,
    [_cPBS, _nT],
    [() => CollaborationPrivacyBudgetSummaryList, 0]
];
export var ListCollaborationPrivacyBudgetTemplatesInput$ = [3, n0, _LCPBTI,
    0,
    [_cIo, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListCollaborationPrivacyBudgetTemplatesOutput$ = [3, n0, _LCPBTO,
    0,
    [_nT, _cPBTS],
    [0, () => CollaborationPrivacyBudgetTemplateSummaryList]
];
export var ListCollaborationsInput$ = [3, n0, _LCI,
    0,
    [_nT, _mR, _mS],
...
export var ListConfiguredAudienceModelAssociationsOutput$ = [3, n0, _LCAMAO,
    0,
    [_cAMAS, _nT],
    [() => ConfiguredAudienceModelAssociationSummaryList, 0]
];
export var ListConfiguredTableAssociationsInput$ = [3, n0, _LCTAI,
    0,
    [_mIe, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListConfiguredTableAssociationsOutput$ = [3, n0, _LCTAO,
    0,
    [_cTAS, _nT],
    [() => ConfiguredTableAssociationSummaryList, 0]
];
export var ListConfiguredTablesInput$ = [3, n0, _LCTI,
    0,
    [_nT, _mR],
    [[0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListConfiguredTablesOutput$ = [3, n0, _LCTO,
    0,
    [_cTS, _nT],
    [() => ConfiguredTableSummaryList, 0]
];
export var ListIdMappingTablesInput$ = [3, n0, _LIMTI,
    0,
    [_mIe, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListIdMappingTablesOutput$ = [3, n0, _LIMTO,
    0,
    [_iMTS, _nT],
    [() => IdMappingTableSummaryList, 0]
];
export var ListIdNamespaceAssociationsInput$ = [3, n0, _LINAI,
    0,
    [_mIe, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListIdNamespaceAssociationsOutput$ = [3, n0, _LINAO,
    0,
    [_nT, _iNAS],
...
export var ListMembershipsOutput$ = [3, n0, _LMO,
    0,
    [_nT, _mSe],
    [0, () => MembershipSummaryList]
];
export var ListMembersInput$ = [3, n0, _LMIi,
    0,
    [_cIo, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListMembersOutput$ = [3, n0, _LMOi,
    0,
    [_nT, _mSem],
    [0, () => MemberSummaryList]
];
export var ListPrivacyBudgetsInput$ = [3, n0, _LPBI,
    0,
    [_mIe, _pBT, _nT, _mR, _aBRA],
    [[0, 1], [0, { [_hQ]: _pBT }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }], [0, { [_hQ]: _aBRA }]]
];
export var ListPrivacyBudgetsOutput$ = [3, n0, _LPBO,
    0,
    [_pBS, _nT],
    [() => PrivacyBudgetSummaryList, 0]
];
export var ListPrivacyBudgetTemplatesInput$ = [3, n0, _LPBTI,
    0,
    [_mIe, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListPrivacyBudgetTemplatesOutput$ = [3, n0, _LPBTO,
    0,
    [_nT, _pBTS],
    [0, () => PrivacyBudgetTemplateSummaryList]
];
export var ListProtectedJobsInput$ = [3, n0, _LPJI,
    0,
    [_mIe, _st, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _st }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListProtectedJobsOutput$ = [3, n0, _LPJO,
    0,
    [_nT, _pJr],
    [0, () => ProtectedJobSummaryList]
];
export var ListProtectedQueriesInput$ = [3, n0, _LPQI,
    0,
    [_mIe, _st, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _st }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListProtectedQueriesOutput$ = [3, n0, _LPQO,
    0,
    [_nT, _pQr],
    [0, () => ProtectedQuerySummaryList]
];
export var ListSchemasInput$ = [3, n0, _LSI,
    0,
    [_cIo, _sTc, _nT, _mR],
    [[0, 1], [0, { [_hQ]: _sTc }], [0, { [_hQ]: _nT }], [1, { [_hQ]: _mR }]]
];
export var ListSchemasOutput$ = [3, n0, _LSO,
    0,
    [_sS, _nT],
    [() => SchemaSummaryList, 0]
];
...
export var MembershipJobComputePaymentConfig$ = [3, n0, _MJCPC,
    0,
    [_iR],
    [2]
];
export var MembershipMLPaymentConfig$ = [3, n0, _MMLPC,
    0,
    [_mT, _mIo, _sDG],
...
export var MembershipModelInferencePaymentConfig$ = [3, n0, _MMIPC,
    0,
    [_iR],
    [2]
];
export var MembershipModelTrainingPaymentConfig$ = [3, n0, _MMTPC,
    0,
    [_iR],
    [2]
];
export var MembershipPaymentConfiguration$ = [3, n0, _MPC,
    0,
    [_qCu, _mL, _jCo],
...
export var MembershipSummary$ = [3, n0, _MS,
    0,
...
export var MembershipSyntheticDataGenerationPaymentConfig$ = [3, n0, _MSDGPC,
    0,
    [_iR],
    [2]
];
...
export var MLPaymentConfig$ = [3, n0, _MLPC,
    0,
    [_mT, _mIo, _sDG],
...
export var ModelTrainingPaymentConfig$ = [3, n0, _MTPC,
    0,
    [_iR],
    [2]
];
...
export var PopulateIdMappingTableInput$ = [3, n0, _PIMTI,
    0,
    [_iMTI, _mIe, _jT],
    [[0, 1], [0, 1], 0]
];
export var PopulateIdMappingTableOutput$ = [3, n0, _PIMTO,
    0,
    [_iMJI],
    [0]
];
...
export var PreviewPrivacyImpactOutput$ = [3, n0, _PPIO,
    0,
    [_pI],
    [() => PrivacyImpact$]
];
export var PrivacyBudgetSummary$ = [3, n0, _PBS,
    0,
    [_i, _pBTI, _pBTA, _mI, _mA, _cI, _cA, _t, _cT, _uT, _b],
    [0, 0, 0, 0, 0, 0, 0, 0, 4, 4, () => PrivacyBudget$]
];
export var PrivacyBudgetTemplate$ = [3, n0, _PBT,
    0,
    [_i, _a, _mI, _mA, _cI, _cA, _cT, _uT, _pBT, _aR, _pa],
    [0, 0, 0, 0, 0, 0, 4, 4, 0, 0, () => PrivacyBudgetTemplateParametersOutput$]
];
export var PrivacyBudgetTemplateSummary$ = [3, n0, _PBTS,
    0,
...
export var ProtectedJobError$ = [3, n0, _PJE,
    0,
    [_m, _co],
    [0, 0]
];
...
export var ProtectedJobS3OutputConfigurationInput$ = [3, n0, _PJSOCI,
    0,
    [_bu, _kP],
    [0, 0]
];
export var ProtectedJobS3OutputConfigurationOutput$ = [3, n0, _PJSOCO,
    0,
    [_bu, _kP],
    [0, 0]
];
...
export var ProtectedQuery$ = [3, n0, _PQ,
    ...
    [0, 0, 0, 4, [() => ProtectedQuerySQLParameters$, 0], 0, () => ProtectedQueryResultConfiguration$, () => ProtectedQueryStatistics$, () => ProtectedQueryResult$, () => ProtectedQueryError$, () => DifferentialPrivacyParameters$, () => ComputeConfiguration$]
];
...
export var ProtectedQueryDistributeOutputConfiguration$ = [3, n0, _PQDOC,
    0,
    [_lo],
    [() => ProtectedQueryDistributeOutputConfigurationLocations]
];
export var ProtectedQueryError$ = [3, n0, _PQE,
    0,
    [_m, _co],
    [0, 0]
];
...
export var ProtectedQueryS3OutputConfiguration$ = [3, n0, _PQSOC,
    0,
    [_rF, _bu, _kP, _sFO],
    [0, 0, 0, 2]
];
...
export var QueryConstraintRequireOverlap$ = [3, n0, _QCRO,
    0,
    [_colu],
    [64 | 0]
];
...
export var Schema$ = [3, n0, _S,
    ...
    [() => ColumnList, () => ColumnList, 64 | 0, 0, 64 | 0, 0, 0, 0, 0, 0, 4, 4, 0, () => SchemaStatusDetailList, 0, () => SchemaTypeProperties$]
];
export var SchemaAnalysisRuleRequest$ = [3, n0, _SARR,
    0,
    [_n, _t],
    [0, 0]
];
...
export var SyntheticDataGenerationPaymentConfig$ = [3, n0, _SDGPC,
    0,
    [_iR],
    [2]
];
...
export var UpdateAnalysisTemplateInput$ = [3, n0, _UATI,
    0,
    [_mIe, _aTI, _de],
    [[0, 1], [0, 1], 0]
];
...
export var UpdateCollaborationChangeRequestOutput$ = [3, n0, _UCCRO,
    0,
    [_cCR],
    [() => CollaborationChangeRequest$]
];
export var UpdateCollaborationInput$ = [3, n0, _UCI,
    0,
    [_cIo, _n, _de, _aE],
    [[0, 1], 0, 0, 0]
];
...
export var UpdateConfiguredAudienceModelAssociationOutput$ = [3, n0, _UCAMAO,
    0,
    [_cAMAo],
    [() => ConfiguredAudienceModelAssociation$]
];
export var UpdateConfiguredTableAnalysisRuleInput$ = [3, n0, _UCTARI,
    0,
    [_cTIo, _aRTn, _aRP],
    [[0, 1], [0, 1], () => ConfiguredTableAnalysisRulePolicy$]
];
export var UpdateConfiguredTableAnalysisRuleOutput$ = [3, n0, _UCTARO,
    0,
    [_aRna],
    [() => ConfiguredTableAnalysisRule$]
];
export var UpdateConfiguredTableAssociationAnalysisRuleInput$ = [3, n0, _UCTAARI,
    0,
    [_mIe, _cTAIo, _aRTn, _aRP],
    [[0, 1], [0, 1], [0, 1], () => ConfiguredTableAssociationAnalysisRulePolicy$]
];
export var UpdateConfiguredTableAssociationAnalysisRuleOutput$ = [3, n0, _UCTAARO,
    0,
    [_aRna],
    [() => ConfiguredTableAssociationAnalysisRule$]
];
export var UpdateConfiguredTableAssociationInput$ = [3, n0, _UCTAI,
    0,
    [_cTAIo, _mIe, _de, _rAo],
    [[0, 1], [0, 1], 0, 0]
];
export var UpdateConfiguredTableAssociationOutput$ = [3, n0, _UCTAO,
    0,
    [_cTAo],
    [() => ConfiguredTableAssociation$]
];
export var UpdateConfiguredTableInput$ = [3, n0, _UCTI,
    0,
    [_cTIo, _n, _de, _tR, _aCl, _aM, _sAM],
    [[0, 1], 0, 0, () => TableReference$, 64 | 0, 0, 64 | 0]
];
export var UpdateConfiguredTableOutput$ = [3, n0, _UCTO,
    0,
    [_cTo],
    [() => ConfiguredTable$]
];
export var UpdateIdMappingTableInput$ = [3, n0, _UIMTI,
    0,
    [_iMTI, _mIe, _de, _kKA],
    [[0, 1], [0, 1], 0, 0]
];
export var UpdateIdMappingTableOutput$ = [3, n0, _UIMTO,
    0,
    [_iMT],
    [() => IdMappingTable$]
];
export var UpdateIdNamespaceAssociationInput$ = [3, n0, _UINAI,
    0,
    [_iNAI, _mIe, _n, _de, _iMC],
    [[0, 1], [0, 1], 0, 0, () => IdMappingConfig$]
];
export var UpdateIdNamespaceAssociationOutput$ = [3, n0, _UINAO,
    0,
    [_iNA],
    [() => IdNamespaceAssociation$]
];
...
export var UpdatePrivacyBudgetTemplateOutput$ = [3, n0, _UPBTO,
    0,
    [_pBTr],
    [() => PrivacyBudgetTemplate$]
];
export var UpdateProtectedJobInput$ = [3, n0, _UPJI,
    0,
    [_mIe, _pJI, _tSa],
    [[0, 1], [0, 1], 0]
];
...
export var UpdateProtectedQueryOutput$ = [3, n0, _UPQO,
    0,
    [_pQ],
    [[() => ProtectedQuery$, 0]]
];
...
export var ConfigurationDetails$ = [4, n0, _CD,
    0,
    [_dACD],
    [() => DirectAnalysisConfigurationDetails$]
];
export var ConfiguredTableAnalysisRulePolicy$ = [4, n0, _CTARP,
    0,
    [_v_],
    [() => ConfiguredTableAnalysisRulePolicyV1$]
];
export var ConfiguredTableAnalysisRulePolicyV1$ = [4, n0, _CTARPV,
    0,
    [_li, _agg, _cu],
    [() => AnalysisRuleList$, () => AnalysisRuleAggregation$, () => AnalysisRuleCustom$]
];
export var ConfiguredTableAssociationAnalysisRulePolicy$ = [4, n0, _CTAARP,
    0,
    [_v_],
    [() => ConfiguredTableAssociationAnalysisRulePolicyV1$]
];
export var ConfiguredTableAssociationAnalysisRulePolicyV1$ = [4, n0, _CTAARPV,
    0,
    [_li, _agg, _cu],
...
export var ConsolidatedPolicy$ = [4, n0, _CP,
    0,
    [_v_],
    [() => ConsolidatedPolicyV1$]
];
export var ConsolidatedPolicyV1$ = [4, n0, _CPV,
    0,
    [_li, _agg, _cu],
...
export var MembershipProtectedQueryOutputConfiguration$ = [4, n0, _MPQOC,
    0,
    [_s_],
...
export var SyntheticDataParameters$ = [4, n0, _SDP,
    0,
    [_mSDP],
    [() => MLSyntheticDataParameters$]
];
export var TableReference$ = [4, n0, _TR,
    0,
    [_g, _sn, _at],
...
export var BatchGetCollaborationAnalysisTemplate$ = [9, n0, _BGCAT,
...
export var CreateConfiguredAudienceModelAssociation$ = [9, n0, _CCAMAr,
...
export var CreateConfiguredTable$ = [9, n0, _CCT,
    { [_h]: ["POST", "/configuredTables", 200] }, () => CreateConfiguredTableInput$, () => CreateConfiguredTableOutput$
];
export var CreateConfiguredTableAnalysisRule$ = [9, n0, _CCTAR,
...
export var CreateConfiguredTableAssociation$ = [9, n0, _CCTA,
...
export var CreateConfiguredTableAssociationAnalysisRule$ = [9, n0, _CCTAAR,
...
export var CreateIdMappingTable$ = [9, n0, _CIMT,
...
export var CreatePrivacyBudgetTemplate$ = [9, n0, _CPBTr,
...
export var DeleteAnalysisTemplate$ = [9, n0, _DAT,
...
export var DeleteConfiguredTableAssociation$ = [9, n0, _DCTA,
...
export var DeleteConfiguredTableAssociationAnalysisRule$ = [9, n0, _DCTAAR,
...
export var DeleteIdMappingTable$ = [9, n0, _DIMT,
...
export var DeleteMembership$ = [9, n0, _DMe,
...
export var GetCollaborationChangeRequest$ = [9, n0, _GCCR,
...
export var GetCollaborationConfiguredAudienceModelAssociation$ = [9, n0, _GCCAMA,
...
export var GetCollaborationIdNamespaceAssociation$ = [9, n0, _GCINA,
...
export var GetCollaborationPrivacyBudgetTemplate$ = [9, n0, _GCPBT,
...
export var GetConfiguredAudienceModelAssociation$ = [9, n0, _GCAMA,
...
export var GetConfiguredTableAssociation$ = [9, n0, _GCTA,
...
export var GetConfiguredTableAssociationAnalysisRule$ = [9, n0, _GCTAAR,
...
export var GetIdMappingTable$ = [9, n0, _GIMT,
...
export var GetPrivacyBudgetTemplate$ = [9, n0, _GPBT,
...
export var GetProtectedJob$ = [9, n0, _GPJ,
...
export var GetProtectedQuery$ = [9, n0, _GPQ,
...
export var ListCollaborationAnalysisTemplates$ = [9, n0, _LCAT,
...
export var ListCollaborationChangeRequests$ = [9, n0, _LCCR,
...
export var ListCollaborationConfiguredAudienceModelAssociations$ = [9, n0, _LCCAMA,
...
export var ListCollaborationIdNamespaceAssociations$ = [9, n0, _LCINA,
...
export var ListCollaborationPrivacyBudgets$ = [9, n0, _LCPB,
...
export var ListCollaborationPrivacyBudgetTemplates$ = [9, n0, _LCPBT,
...
export var ListCollaborations$ = [9, n0, _LC,
    { [_h]: ["GET", "/collaborations", 200] }, () => ListCollaborationsInput$, () => ListCollaborationsOutput$
];
export var ListConfiguredAudienceModelAssociations$ = [9, n0, _LCAMA,
...
export var ListConfiguredTableAssociations$ = [9, n0, _LCTA,
...
export var ListConfiguredTables$ = [9, n0, _LCT,
    { [_h]: ["GET", "/configuredTables", 200] }, () => ListConfiguredTablesInput$, () => ListConfiguredTablesOutput$
];
export var ListIdMappingTables$ = [9, n0, _LIMT,
...
export var StartProtectedQuery$ = [9, n0, _SPQ,
...
export var UpdateAnalysisTemplate$ = [9, n0, _UAT,
...
export var UpdateConfiguredAudienceModelAssociation$ = [9, n0, _UCAMA,
...
export var UpdateConfiguredTableAssociation$ = [9, n0, _UCTA,
...
export var UpdateConfiguredTableAssociationAnalysisRule$ = [9, n0, _UCTAAR,
...
export var UpdateIdMappingTable$ = [9, n0, _UIMT,
...
export var UpdatePrivacyBudgetTemplate$ = [9, n0, _UPBT,
...
export var UpdateProtectedJob$ = [9, n0, _UPJ,
...
export var UpdateProtectedQuery$ = [9, n0, _UPQ,
